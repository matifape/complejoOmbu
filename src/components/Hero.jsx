  ...
  return (
    <section id="mainContent" className="mt-20 md:mt-50">
      ...
      <div className="flex flex-col shadow-xl p-5">
        <h2 className="text-center mt-10 md:mt-20 md:mb-5 md:text-2xl">El Complejo</h2>
        <div className="md:flex md:items-center md:w-[90%] md:mx-auto">
          ...
          <p className="p-2 text-left md:font-light md:leading-loose">Los invitamos a conocer nuestro complejo, donde van a encontrar la mejor atencion, comodidad, tranquilidad y todo lo que necesitas para tus vacaciones. <br />
