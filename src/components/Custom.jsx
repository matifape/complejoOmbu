    ...
    >
      ...
      <div className={`flex flex-col ${layoutDirection} items-center`}>
        <div className="relative flex   items-center w-full md:w-[50%] mx-auto">
          <button
            className="absolute md:left-2.5  p-4 rounded-full shadow-md cursor-pointer bg-gray-100 hover:bg-gray-300 "
          ...
          <div className="max-w-[500px] mx-auto">
            <img
              ...
              className="w-full  md:ml-2 hover:cursor-pointer rounded-md shadow-sm transition-all duration-500 hover:scale-105 border-5 border-[var(--marron-madera)]"
              alt="foto"
          ...
          <button
            className="absolute right-0 p-4  rounded-full shadow-md cursor-pointer bg-gray-100 hover:bg-gray-300 "
            onClick={() => goToFoto(currentIndex + 1)}
          >
            <IoIosArrowForward />
          </button>
        ...
        <div className="info  flex flex-col ml-5 justify-center md:ml-32 md:w-[45%] md:pl-5 ">
          <h3 className="mb-5 mt-1 text-xl md:text-l font-light uppercase text-white">
            Descripcion{" "}
          </h3>
          <p className="md:text-left md:text-l text-white whitespace-pre-line">
            {textInfo}
          </p>
          <WhatsAppButton
